...
class StudentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
         foreach ($this->students as $index => $student)
        {
            ...
            LibraryClearanceTableSeeder::setLibraryClearance($student['id']);
            FeeTableSeeder::setFee($student['id']);
            QualityAssuranceTableSeeder::setQualityAssurance($student['id']);
        }
