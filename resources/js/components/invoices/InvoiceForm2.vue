...
import TypeHelper from '../typeahead/TypeHelper';

function initialize(to) {
        let urls = {
            'create': `http://127.0.0.1:8000/admin/invoices/create`,
            'edit': `http://127.0.0.1:8000/admin/invoices/${to.params.id}/edit`
        }
...
export default {
    ...
    data(){
        return{
           customers: [],
            form: {},
            errors: {},
            customerUrl:'http://127.0.0.1:8000/admin/customers/search',
            productUrl:'http://127.0.0.1:8000/admin/products/search'
        }
    },
    computed:{
    ...
    created(){
       console.log(this.fetchCustomers())
