...
Route::group(['prefix'  =>  'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['prefix' => 'registrations'], function(){
         ...
         Route::group(['prefix' => 'libraryclearances'], function(){
            Route::get('/', 'Admin\LibraryClearanceController@index')
                    ->name('admin.libraryclearances.index');
            Route::get('/{id}/edit', 'Admin\LibraryClearanceController@edit')
                    ->name('admin.libraryclearanaces.edit');    
         });  
         
         Route::group(['prefix' => 'fees'], function(){
            Route::get('/', 'Admin\FeeController@index')
                    ->name('admin.fees.index');
         }); 

        Route::group(['prefix' => 'qualityassurances'], function(){
            Route::get('/', 'Admin\QualityAssuranceController@index')
                ->name('admin.qualityassurances.index');
        }); 
